      ...
      <AnimatePresence mode="wait">
        {activeSnack && !completed && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="card glass border-success/20 bg-success/5 p-10 relative overflow-hidden mt-8"
          >
        ...
        {completed && (
          <motion.div
            ...
            className="card glass border-success/20 bg-success/5 p-10 flex flex-col items-center justify-center text-center py-20 mt-8"
          >
