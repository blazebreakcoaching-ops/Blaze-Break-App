...
const DEFAULT_FLAGS: Record<FeatureFlag, boolean> = {
  ...
  enable_recovery_ally: false,
  enable_organisation_enrolment: false,
  enable_anonymous_aggregation_engine: false,
  enable_team_climate_dashboard: false,
  enable_nova_manager_coach: false,
  enable_positive_reinforcement_engine: false,
  enable_anonymous_team_voice: false,
  enable_workplace_governance_console: false,
  enable_people_value_engine: false,
  enable_management_savings_planner: false,
  enable_blaze_bright_moments: false,
